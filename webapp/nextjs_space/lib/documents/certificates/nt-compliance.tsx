...
export const NTCompliance: React.FC<NTComplianceProps> = (props) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>NORTHERN TERRITORY CERTIFICATE OF COMPLIANCE</Text>
        ...
        <Text style={styles.footer}>NT Certificate | AS/NZS 3000:2018 | AS/NZS 5033:2021</Text>
      </Page>
    </Document>
  );
};
