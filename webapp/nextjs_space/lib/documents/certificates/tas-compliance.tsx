/**
 * Tasmania Certificate of Electrical Compliance
 * Certificate of Compliance for Solar PV Installation
 * Office of the Regulator Tasmania
 */
...
export const TASCompliance: React.FC<TASComplianceProps> = (props) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>TASMANIA CERTIFICATE OF ELECTRICAL COMPLIANCE</Text>
        ...
        <Text style={styles.footer}>TAS Certificate | AS/NZS 3000:2018 | AS/NZS 5033:2021</Text>
      </Page>
    </Document>
  );
};
