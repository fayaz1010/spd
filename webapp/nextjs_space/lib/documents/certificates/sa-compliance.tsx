/**
 * South Australia Certificate of Electrical Compliance
 * Certificate of Compliance for Solar PV Installation
...
export const SACompliance: React.FC<SAComplianceProps> = (props) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        {/* Header */}
        <View style={styles.header}>
          <Text style={styles.title}>SOUTH AUSTRALIA</Text>
          <Text style={styles.title}>CERTIFICATE OF ELECTRICAL COMPLIANCE</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={{ marginTop: 10, fontSize: 9 }}>
            ...
            in accordance with AS/NZS 3000:2018, AS/NZS 5033:2021, and all applicable South Australian electrical
            safety legislation.
          </Text>
        ...
        <View style={styles.warningBox}>
          <Text style={styles.warningText}>
            IMPORTANT: This certificate must be submitted to the Office of the Technical Regulator within
            30 days of installation completion.
          </Text>
        </View>

        {/* Footer */}
        <Text style={styles.footer}>
          SA Certificate of Electrical Compliance | AS/NZS 3000:2018 | AS/NZS 5033:2021 | AS/NZS 4777.2:2020
        </Text>
      </Page>
    </Document>
  );
