...
export function TeamMemberElectricianLink({ teamMemberId, electricianId, onLink }: ElectricianLinkProps) {
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex gap-2">
            <Link href={`/admin/dashboard/settings/electricians/new?teamMemberId=${teamMemberId}`}>
              <Button>
